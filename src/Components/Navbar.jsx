...
import HIPAA from "../assets/Images/HIPAAlogo.png";
...
const Navbar = () => {
  ...
  {navItems.map((item, idx) => (
    ...
    >
      {/* text */}
      <motion.span
        className={`relative z-10 ${activeSection === item.id ? "text-white" : "text-black"}`}
        whileHover={{
          color: activeSection === item.id ? "#fff" : "#1e40af",
      ...
      {/* soft glowing pulse for active nav */}
      {activeSection === item.id && (
        <motion.div
