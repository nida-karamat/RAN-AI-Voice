    ...
    <section className="w-full bg-white py-16 px-6 md:px-16 mt-10 overflow-hidden">
      <div className="max-w-7xl mx-auto">
        ...
        <motion.div
          ...
          className="flex items-center gap-2 mb-10 bg-blue-50 w-fit px-4 py-3 sm:py-4 rounded-full border border-blue-300 shadow-sm"
        >
          <GoPencil className="text-indigo-600 text-lg sm:text-xl" />
